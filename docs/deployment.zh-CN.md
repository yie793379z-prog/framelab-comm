...
FrameLab 现在还包含一个网页内说明页 `/ai-setup`。如果你做公开演示站，建议保留这个路由，让访问者直接看到为什么线上演示默认保持 mock 模式，以及本地 / 私有部署如何启用真实 AI。
...
- 部署完成后，访问者可以直接打开 `/ai-setup` 查看同样的配置说明
...
新部署生效后，`/ai-setup` 页面也会反映当前实际的配置思路。
