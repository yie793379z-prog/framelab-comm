export const appDictionary = {
  en: {
    ...
    workspace: {
      ...
      publicDemoNoticeTitle: "Public demo note",
      publicDemoNoticeBody:
        "The hosted public demo uses mock suggestions by default. No API key is needed here. Real AI requires local or self-hosted provider setup.",
  ...
  "zh-CN": {
    ...
    workspace: {
      ...
      publicDemoNoticeTitle: "公开演示说明",
      publicDemoNoticeBody: "当前公开托管演示默认使用模拟建议，不需要 API Key。若要使用真实 AI，请在本地运行或自部署后配置自己的提供方。",
