export const appDictionary = {
  en: {
    ...
    landing: {
      ...
      title: "FrameLab Coding Workspace",
      description:
        "A lightweight workspace for communication, journalism, and media studies students to code texts, review summaries, and export reports.",
      supportLine: "Designed for coursework, small research projects, and early thesis exploration.",
      ...
      whatItIsBody: "Turn news, comments, interviews, and notes into editable coding results.",
      whoItIsForTitle: "Who it is for",
      whoItIsForBody: "Useful for coursework, small research projects, pilot coding, and thesis preparation.",
      notDoTitle: "What it does not do",
      notDoBody: "It does not scrape platforms, understand images automatically, or replace research judgment.",
      ...
      quickStartDescription: "For first-time visitors, this is the shortest path through the product.",
  ...
  "zh-CN": {
    ...
    landing: {
      badge: "面向学生的传播学研究工作流",
      title: "FrameLab 文本编码工作台",
      description:
        "为新闻传播、传播学与媒介研究学生设计。导入文本，选择编码表，整理结果，并导出报告。",
      supportLine: "适合课程作业、小型研究和论文前期探索。",
      onlineDemo: "在线演示",
      openWorkspace: "打开工作区",
      ...
      whatItIsTitle: "这是做什么",
      whatItIsBody: "用于把新闻、评论、访谈等文本整理成可编辑、可导出的编码结果。",
      whoItIsForTitle: "适合谁",
      whoItIsForBody: "适合课程作业、小型研究、试编码和论文前期探索。",
      notDoTitle: "它不会做什么",
      notDoBody: "不会抓取平台内容，不会自动理解图片，也不会替代研究判断。",
      viewTemplates: "查看模板",
      flowTitle: "MVP 流程",
      ...
      quickStartDescription: "如果你是第一次使用，先按这个最短路径体验即可。",
      quickStep1: "打开交互式演示",
      quickStep2: "打开工作区",
      quickStep3: "粘贴示例文本",
      quickStep4: "清理粘贴文本",
