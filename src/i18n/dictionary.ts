export const appDictionary = {
  en: {
    ...
    codingForm: {
      ...
      realModeTitle: "Real AI suggestions",
      ...
      realModeMessage: "Using real AI suggestions from the configured OpenAI provider.",
      realModeMissingKeyMessage: "Real AI mode was requested, but no OPENAI_API_KEY was found. Using mock suggestions instead.",
      realModeErrorFallbackMessage: "Real AI suggestions were unavailable, so FrameLab used mock suggestions instead.",
      realModeMalformedFallbackMessage: "Real AI returned an invalid suggestion payload, so FrameLab used mock suggestions instead.",
  ...
  "zh-CN": {
    ...
    codingForm: {
      ...
      modeLabel: "当前建议模式",
      mockModeTitle: "模拟建议",
      realModeTitle: "真实 AI 建议",
      mockPrivacyNote: "文本保留在本地浏览器中。",
      realPrivacyNote: "当前选中的样本文本会发送到已配置的 AI 提供方。",
      mockModeMessage: "当前使用模拟建议。除非你在服务器端启用真实 AI，否则文本会保留在本地。",
      realModeMessage: "当前使用已配置 OpenAI 提供方的真实 AI 建议。",
      realModeMissingKeyMessage: "已请求启用真实 AI，但未检测到 OPENAI_API_KEY，因此改为使用模拟建议。",
      realModeErrorFallbackMessage: "真实 AI 建议暂时不可用，FrameLab 已自动改用模拟建议。",
      realModeMalformedFallbackMessage: "真实 AI 返回了无效的建议数据，FrameLab 已自动改用模拟建议。",
